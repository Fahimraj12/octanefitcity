...
export default function Service() {
    ...
    const paginatedServices = useMemo(() => {
        ...
        return filteredServices.slice(start, start + recordsPerPage);
        ...
        <Container>
            ...
            <HeaderSection>
                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                    <PageTitle>
                        Wellness <span>/ Services</span>
                    </PageTitle>
                    <Sub>Manage core offerings and facility services</Sub>
                </div>
                                ...
                                <tr>
                                    <td colSpan="5">
                                        <EmptyState>
                                            ...
                                            <p>Try adjusting your search filters or add a new service.</p>
                                        </EmptyState>
                                    </td>
                                </tr>
                            )}
